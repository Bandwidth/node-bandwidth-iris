...
describe("Lidbs", function(){
  ...
  describe("#list", function(){
    it("should return a list of Lidbs Orders ", function(done){
      helper.nock().get("/v1.0/accounts/FakeAccountId/lidbs").reply(200, helper.xml.lidbss, {"Content-Type":"application/xml"});
  ...
  describe("#get", function(){
    it("should get Lidbs successfully", function(done){
      helper.nock().get("/v1.0/accounts/FakeAccountId/lidbs/1").reply(200, helper.xml.lidbs, {"Content-Type": "application/xml"});
